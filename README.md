...
- **Phase 0 (this commit)** Scaffold + roster + read-only stub UI showing three columns.
- **Phase 1** Interactive UI: hover-to-note panel, checkbox tick-offs, message templates, add/remove athlete form.
...
Import this repo on Vercel. No env vars required for Phase 0/1. Phase 2 will add `GOOGLE_OAUTH_CLIENT_ID`, `GOOGLE_OAUTH_CLIENT_SECRET`, and `GOOGLE_OAUTH_REFRESH_TOKEN`.
